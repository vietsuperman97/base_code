  ...
  Stream<ProfileState> mapEventToState(ProfileEvent event) async* {
    if (event is UpdateProfileEvent) {
      ...
      try {
        ...
        print('abcabc: code : $code, type: $type, email: $email, name: $name');
        ...
        if (response.status == BASE_URL.SUCCESS) {
          ...
          await shareLocal.putString(PreferencesKey.USER_CODE, response.data.code);
          await shareLocal.putString(PreferencesKey.USER_EMAIL, response.data.email);
          await shareLocal.putInt(PreferencesKey.USER_TYPE, response.data.type);
